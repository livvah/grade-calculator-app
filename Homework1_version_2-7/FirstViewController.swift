...
class FirstViewController: UIViewController {
    ...
    private func calGrades(){
        ...
        for label in lblGradeValues{
            ...
            case 1:
                thisGrade = Double(sldGradeValues[i].value)
                thisGrade = Double(floor(CGFloat(thisGrade * 0.4)))
            case 2:
                thisGrade = Double(sldGradeValues[i].value)
                thisGrade = Double(floor(CGFloat(thisGrade * 0.1)))
            case 3:
                thisGrade = Double(sldGradeValues[i].value)
                thisGrade = Double(floor(CGFloat(thisGrade * 0.05)))
            case 4:
                thisGrade = Double(sldGradeValues[i].value)
                thisGrade = Double(floor(CGFloat(thisGrade * 0.15)))
            case 5:
                thisGrade = Double(sldGradeValues[i].value)
                thisGrade = Double(floor(CGFloat(thisGrade * 0.1)))
